...
In this section, let us explore and understand this 17th century idea on how we could effectively do a speed control for the DC Motor, the [PID Controller]("https://en.wikipedia.org/wiki/PID_controller_test){:target="_blank" rel="noopener"} mechanism
